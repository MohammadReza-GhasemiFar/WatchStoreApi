...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.product.create',compact('title','colors','brands','categories'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $brands = Brand::query()->pluck('title','id');
        $colors = Color::query()->pluck('title','id');
        return view('admin.product.edit',compact('title','colors','product','categories','brands'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $product->update([
            ...
            'price'=>$request->input('price'),
            'count'=>$request->input('count'),
            'image'=>($request->file ? $image : $product->image),//ین برای وقتی هست که عکس رو نمیخوام ادیت کنیم و از عکس قبلی استفاده میکنه
            'guaranty'=>$request->input('guaranty'),
            'discount'=>$request->input('discount'),
            'description'=>$request->input('description'),
            'is_special'=>$request->input('is_special') === 'on',
