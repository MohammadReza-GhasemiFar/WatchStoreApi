            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <figure class="avatar avatar">
                        <img src="{{url('images/admin/categories/small/'.$category->image)}}" class="rounded-circle" alt="image">
                    </figure>
                </td>
...
@section('scripts')
    <script>
        window.addEventListener('deleteCategory',event=>{
            Swal.fire({
                title: "آیا ازحذف دسته بندی مطمئن هستید؟",
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('destroyCategory', {id:event.detail[0].id})
                    Swal.fire({
