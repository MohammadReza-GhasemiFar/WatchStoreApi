<div class="table overflow-auto" tabindex="8">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th class="text-center align-middle text-primary">قیمت همراه با تخفیف</th>
        ...
        @foreach($order_details as $index => $detail)
            ...
            <tr>
                ...
                <td class="text-center align-middle">{{number_format($detail->discount_price)}}</td>
                ...
                <td class="text-center align-middle" wire:click="changeStatus({{$detail->id}})">
                    @if($detail->status === \App\Enums\OrderStatus::Received->value)
                        <span class="badge badge-success cursor-pointer">تحویل داده شد</span>
