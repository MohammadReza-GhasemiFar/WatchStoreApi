            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <figure class="avatar avatar">
                        <img src="{{url('images/admin/products/small/'.$product->image)}}" class="rounded-circle" alt="image">
                    </figure>
                </td>
                ...
                <td class="text-center align-middle">
                    <a class="btn btn-outline-success" href="{{route('create.product.gallery',$product->id)}}">
                        گالری
                    </a>
                </td>
                <td class="text-center align-middle">
                    <a class="btn btn-outline-success" href="{{route('create.product.properties',$product->id)}}">
                        ویژگی ها
                    </a>
                </td>
                <td class="text-center align-middle">
...
@section('scripts')
    <script>
        window.addEventListener('deleteProduct',event=>{
            Swal.fire({
                title: "آیا ازحذف محصول بندی مطمئن هستید؟",
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('destroyProduct',{id:event.detail[0].id});
                    Swal.fire({
